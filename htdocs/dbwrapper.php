...
<?php
    ...
    function DBQueryDML($conn,$query) {
        ...
        return [$success,[], $error ?? NULL,$affectedrows,$insertid];
    }
    ...
    function DBQueryDMLMulti($conn,$query) {
        ...
        {
            $affectedrows = $affectedrows + mysqli_affected_rows($conn);
        }
    ...
    function DBQueryNoDML($conn,$query,$mode=MYSQLI_BOTH) {
        $result = mysqli_query($conn,$query);
        if ($result) {
            $result = mysqli_fetch_all($result,$mode);
            $success = true;            
        } else {
            $success= false;
            $error = mysqli_error($conn);
